...
export const constantRouterMap = [
  ...
  //   name: 'list',
  //   hidden: true,
  //   children: [{path: '/product/list', title: 'list', name: 'list', component: _import('product/list')}]
  // },
  //登陆进去显示首页
  {
    path: '/',
  ...
  //   path: '/',
  //   component: Layout,
  //   redirect: '/qudao/qudaoRegister',
  //   name: 'qudaoRegister',
  //   hidden: true,
  //   children: [{path: '/qudao/qudaoRegister', title: 'qudaoRegister', name: 'qudaoRegister', component: _import('qudao/qudaoRegister')}]
  // }
];
//默认控件
