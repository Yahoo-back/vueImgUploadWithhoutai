...
<template>
    ...
    <div slot="header" class="clearfix">
        <span class="title">{{this.$route.query.view == 1 ? "查看商品" : this.$route.query.view == 2 ? "编辑商品" : this.$route.query.view == 3 ? "新增商品" : ""}}</span>
    </div>
    <!-- <el-collapse v-model="activeNames" @change="handleChange">
        ...
        <el-form ref="form" :model="form" :rules="rules" label-width="180px">
          ...
          <el-form-item label="商品名称：" prop="name">
            <el-col :span="8">
              ...
              <!-- <el-input v-if="this.$route.query.view==1" v-model="form.name"></el-input> -->
          ...
          <el-form-item label="logo：" prop="logo" v-else-if="this.$route.query.view==2"> 
            <el-upload
              action=""
          ...
          <el-form-item label="logo：" prop="logo" v-else-if="this.$route.query.view==3"> 
            <el-upload
              action=""
              list-type="picture-card"
              :on-preview="handlePictureCardPreview"
            ...
            <el-dialog :visible.sync="dialogVisible">
              <img width="100%" :src="logo" alt="" v-model="form.logo">
            </el-dialog>
          </el-form-item> -->
          <el-form-item label="logo：" prop="logo" v-if="this.$route.query.view==1"> 
          ...
          <!-- <el-form-item label="logo：" prop="logo" v-else-if="this.$route.query.view==2"> 
            <img :src="'http://47.96.101.223:7001'+form.logo" class="avatar">
          </el-form-item> -->
          <el-form-item label="logo：" prop="logo" v-else>
            ...
            <!-- <el-upload
              ...
              :before-upload="beforeAvatarUpload">
                <img v-if="this.$route.query.view==1 || logo" :src="logo" class="avatar">
                <img v-else-if="this.$route.query.view==2 || logo" :src="logo" v-model="form.logo" class="avatar">
                <i v-else="this.$route.query.view==3" :src="logo" v-model="form.logo" class="el-icon-plus avatar-uploader-icon"></i>
            </el-upload> -->
          <!-- </el-form-item> -->
          ...
          <el-row :gutter="24">
            <el-col :xs="4" :sm="6" :md="8" :lg="6" :xl="12">
              <el-form-item label="利息：" prop="interest">
                ...
                <!-- <el-input v-if="this.$route.query.view==1" v-model="form.interest" placeholder="请输入小数或者整数">
            ...
            <el-col :xs="4" :sm="6" :md="10" :lg="12" :xl="12">
              <el-form-item label="可授信额度：" prop="money">
                ...
                <!-- <el-select v-if="this.$route.query.view==1" v-model="form.money" placeholder="请选择" >
                  <el-option  value="">请选择</el-option>
          ...
          <el-row :gutter="24">
            ...
            <el-col :xs="4" :sm="6" :md="8" :lg="8" :xl="12">
              <el-form-item label="可分期期数：" prop="periodization">
                ...
                <!-- <el-input v-if="this.$route.query.view==1" v-model="form.periodization">
          ...
          <el-form-item label="链接：" prop="link">
            <el-col :span="8">
              ...
              <!-- <el-input v-if="this.$route.query.view==1" v-model="form.link"></el-input> -->
              ...
              <!-- <el-input :value="this.link" v-if="this.$route.query.view==1" v-model="form.link"></el-input> -->
            </el-col>
          </el-form-item>
          <!-- <el-form-item label="结算方式：" prop="settleWayCpa">
            <el-row>
              <el-col :xs="2" :sm="2" :md="2" :lg="2" :xl="2">
                <el-radio v-if="this.$route.query.view==1 && this.form.settleWayCpa != 'null' " v-model="form.settle_cpa" :label="0">CPA</el-radio>
                <el-radio v-else-if="this.$route.query.view==2" v-model="form.settle_cpa" :label="0">CPA</el-radio>
                <el-radio v-else="this.$route.query.view==3" v-model="form.settle_cpa" :label="0">CPA</el-radio>
              </el-col>
          ...
          <el-form-item label="结算周期：" prop="settleCycle">
            <el-col :span="8">
              ...
              <!-- <el-input v-if="this.$route.query.view==1" v-model="form.settleCycle" placeholder="请填写结算周期，如日结、周结、每周五结算等"></el-input> -->
              ...
              <!-- <el-input v-model="form.settleCycle"></el-input> -->
            </el-col>
          </el-form-item>
          ...
          <!-- <el-form-item label="申请条件：" prop="requires">
            <el-checkbox-group v-if="this.$route.query.view==1" v-model="form.requires">
              <el-checkbox  v-for="item in apply_require" :label="item.id" :key="item.id" disabled>{{item.itemValue}}</el-checkbox>
            </el-checkbox-group>
            <el-checkbox-group v-else-if="this.$route.query.view==2" v-model="form.requires">
              <el-checkbox  v-for="item in apply_require" :label="item.id" :key="item.id" >{{item.itemValue}}</el-checkbox>
            </el-checkbox-group>
            <el-checkbox-group v-else="this.$route.query.view==3" v-model="requires">
              <el-checkbox @change="changeCheckr(item)" v-for="item in apply_require" :label="item.id" :key="item.id" >{{item.itemValue}}</el-checkbox>
            </el-checkbox-group>
          </el-form-item> -->
          <!-- <el-form-item label="申请资料：" prop="datas">
            <el-checkbox-group v-if="this.$route.query.view==1" v-model="form.datas">
              <el-checkbox  v-for="item in apply_data" :label="item.id" :key="item.id" disabled>{{item.itemValue}}</el-checkbox>
            </el-checkbox-group>
            <el-checkbox-group v-else-if="this.$route.query.view==2" v-model="form.datas">
              <el-checkbox  v-for="item in apply_data" :label="item.id" :key="item.id" >{{item.itemValue}}</el-checkbox>
            </el-checkbox-group>
            <el-checkbox-group v-else="this.$route.query.view==3" v-model="datas">
              <el-checkbox @change="changeCheckd(item)" v-for="item in apply_data" :label="item.id" :key="item.id" >{{item.itemValue}}</el-checkbox>
            </el-checkbox-group>
          </el-form-item> -->
          <el-form-item label="费用说明：">
            <el-col :span="8">
              ...
              <!-- <el-input v-if="this.$route.query.view==1" v-model="form.ktxDesc"></el-input> -->
              ...
              <!-- <el-input v-model="form.ktxDesc"></el-input> -->
            </el-col>
          </el-form-item>
          <el-row :gutter="24">
            <el-col :xs="4" :sm="6" :md="8" :lg="6" :xl="12">
              <el-form-item label="状态：" prop="status">
                ...
                <!-- <el-select v-if="this.$route.query.view==1" v-model="form.status" placeholder="请选择">
            ...
            <el-col :xs="4" :sm="6" :md="8" :lg="6" :xl="12">
              <el-form-item label="排序：" prop="sort">
                ...
                <!-- <el-input v-if="this.$route.query.view==1" v-model="form.sort"></el-input> -->
          ...
          <el-row :gutter="24">
            <el-col :xs="4" :sm="6" :md="8" :lg="6" :xl="12">
              <el-form-item label="首页热门：" prop="isHot">
                ...
                <!-- <el-select v-if="this.$route.query.view==1" v-model="form.isHot" placeholder="请选择">
            ...
            <el-col :xs="4" :sm="6" :md="8" :lg="6" :xl="12">
              <el-form-item label="热门排序：" >
                ...
                <!-- <el-input v-if="this.$route.query.view==1" v-model="form.hotSort"></el-input> -->
          ...
          <el-form-item label="后台链接：" >
            <el-col :span="8">
              ...
              <!-- <el-input v-if="this.$route.query.view==1" v-model="form.managerUrl"></el-input> -->
          ...
          <el-row :gutter="24">
            <el-col :xs="4" :sm="6" :md="8" :lg="6" :xl="12">
              <el-form-item label="后台登陆用户名：">
                ...
                <!-- <el-input v-if="this.$route.query.view==1" v-model="form.managerUser"></el-input> -->
            ...
            <el-col :xs="4" :sm="6" :md="8" :lg="6" :xl="12">
              <el-form-item label="后台登陆用户密码：">
                ...
                <!-- <el-input v-if="this.$route.query.view==1" v-model="form.managerPassword"></el-input> -->
          ...
          <el-form-item label="所属公司：" prop="company">
            <el-col :span="8">
              ...
              <!-- <el-input v-if="this.$route.query.view==1" v-model="form.company"></el-input> -->
          ...
          <el-row :gutter="24">
            <el-col :xs="4" :sm="6" :md="8" :lg="6" :xl="12">
              <el-form-item label="产品联系人：">
                ...
                <!-- <el-input v-if="this.$route.query.view==1" v-model="form.contact"></el-input> -->
            ...
            <el-col :xs="4" :sm="6" :md="8" :lg="6" :xl="12">
              <el-form-item label="产品联系人联系方式：">
                ...
                <!-- <el-input v-if="this.$route.query.view==1" v-model="form.contactInfo"></el-input> -->
          ...
          <el-row :gutter="24">
            <el-col :xs="8" :sm="12" :md="12" :lg="12" :xl="12">
              <el-form-item label="商品描述（申请攻略）:" prop="description">
                ...
                <!-- <el-input v-if="this.$route.query.view==1" v-model="form.description"></el-input> -->
      ...
      <!-- <el-collapse-item title="商品描述（申请攻略）" name="2">
        <mavon-editor v-model="description" :toolbars="toolbars" @keydown="" @change="changeData"/>
      </el-collapse-item> -->
    <!-- </el-collapse> -->
    <div style="float: right; margin-top: 25px; margin-bottom: 20px">
      ...
      <el-button @click="reback('form')">取消</el-button>   
    </div>
  </el-card>
        ...
        if(view == 1 || view == 2 ) {
          qryProductById({id: this.$route.query.id}).then(res=>{
            if(res.data.code == 200) {
              ...
              this.form.logo = 'http://47.96.101.223:7001'+this.productInfo.logo;
        ...
        this.$refs[option].validate((valid) => {
          if (valid) {
            ...
            saveProduct({
              name: this.form.name, 
              logo: this.form.logo,
              classifyId: this.form.classifyId == "现金贷" ? "1" : this.form.classifyId == "借条" ? "0" : "",
              ...
              settleWayCpa: this.settleWayCpa,
              settleCycle: this.settleCycle,
              conditionList: testc,
              dataList: testd,
              ktxDesc: this.form.ktxDesc,
              status: this.form.status == "下架" ? "0" : this.form.status == "上架" ? "1": "",
              sort: this.form.sort,
              isHot: this.form.isHot == "否" ? "0" : this.form.isHot == "是" ? "1" : "",
