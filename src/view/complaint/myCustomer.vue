        ...
        <el-table
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              ...
              <el-dialog :append-to-body='true' title="退款" :visible.sync="dialogVisibles" :before-close="closeDiv"  @close="onDialogClose()" >
               ...
               <el-dialog :append-to-body='true' title="驳回" :visible.sync="dialogVisibless" :before-close="closeDiv"  @close="onDialogClose()" >
                ...
                <div slot="footer" class="dialog-footer">
                  ...
                  <el-button @click="handleCancles()">取消</el-button>
                </div>
              </el-dialog>
            </template>
          </el-table-column>
